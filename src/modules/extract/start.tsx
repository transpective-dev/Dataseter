...
import { type session_execute_p, type schema_base } from "../../logic/interface/session.interface.ts";
...
export const Start = ({
  ...
  return (
    <Box flexDirection="column" gap={1}>
      ...
      {status === "done" && (
        <Box>
          <Text color={palette.success}>✔ Extraction completed successfully</Text>
        </Box>
      )}
    </Box>
  );
